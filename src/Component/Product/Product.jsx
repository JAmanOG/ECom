...
const Product = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={appwriteService.getFilePreview(product.featuredImage)}/>
   ...
   {product.discountPercent > 0 ? (
     <>
       <span className="title-font font-medium text-2xl text-gray-900">${product.discountedPrice}</span>
       <span className="flex ml-4">
         <strike>
           <p className="mt-1 title-font font-medium text-2xl text-gray-500">${product.price}</p>
         </strike>
