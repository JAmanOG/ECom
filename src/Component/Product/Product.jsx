  ...
  return (
    <div>
      <div className="items-center w-max flex m-5">
        <Link className="flex font-bold" to={`/${category}/${subcategory}/${subsubcategory}`}>
        <span className="material-symbols-outlined">arrow_back_ios</span>{" "}
        <span>Back to {subsubcategory.replace(/-/g, " ")}</span>
        </Link>
      </div>
                ...
                {product.discountPercent > 0 ? (
                  <>
                    ...
                    <span className="flex ml-4">
                      <strike>
                        <p className="mt-1 title-font font-medium text-2xl text-gray-500">
                          ${product.price}
                        </p>
                      </strike>
