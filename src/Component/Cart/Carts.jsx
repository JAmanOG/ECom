...
function Carts() {
  ...
  const { subtotal, savings, shipping, tax, total } = useCalculateTotals(checkout, productDetails);
            ...
            <div className="card-body">
              {loading ? (
                Array.from({ length: 3 }).map((_, index) => (
                  <div key={index} className="flex items-center mt-2 rounded-md shadow space-x-8">
                    <Skeleton height={160} width={160} />
                    <div className="flex-1">
                      <Skeleton height={30} width={`60%`} />
                      <Skeleton height={40} width={`80%`} style={{ marginTop: '1rem' }} />
                      <Skeleton height={25} width={`30%`} style={{ marginTop: '1rem' }} />
                    </div>
                  </div>
                ))
              ) : (
                checkout.length > 0 ? (
                  checkout.map((item) => (
                    <div key={item.productId} className="flex items-center mt-2 rounded-md shadow hover:shadow-lg space-x-8">
                      <div className="product-image mb-3">
                        <img
                          className="h-40 w-40 object-cover"
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-2xl font-bold text-red-500 mt-1">
                              ${productDetails[item.productId]?.discountedPrice || "0.00"}
                            </p>
                            <span className="block text-green-500 text-sm font-semibold mt-1">
                              {productDetails[item.productId]?.discountPercent || "0.00"}% Off
                            </span>
                          </div>
                        </div>
                        <div className="flex space-x-6">
            ...
            <div className="card-body">
              ...
              {loading ? (
                <>
                  ...
                  <Skeleton height={30} width={`50%`} style={{ marginTop: '1rem' }} />
                  <Skeleton height={30} width={`50%`} style={{ marginTop: '1rem' }} />
                  <Skeleton height={30} width={`50%`} style={{ marginTop: '1rem' }} />
                  <Skeleton height={30} width={`50%`} style={{ marginTop: '1rem' }} />
                </>
