        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-left md:w-1/3">
              <h2 className="text-2xl font-bold text-white">FOOTDISE</h2>
              <p className="mt-2 text-gray-400">
                Providing quality footwear for every journey. Join us and walk the path of excellence.
              </p>
              <p className="mt-4 text-sm">&copy; {new Date().getFullYear()} FOOTDISE. All Rights Reserved.</p>
            </div>

            {/* Social Media Links */}
            <div className="flex justify-center mt-6 md:mt-0 md:w-1/3 space-x-6">
              <a href="#" className="text-gray-300 hover:text-white transition duration-300">
                <svg fill="currentColor" className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
