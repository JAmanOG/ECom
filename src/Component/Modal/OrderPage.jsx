                ...
                {sortedOrders.map((order, index) => (
                    <div key={index} className="p-6 border-b border-gray-200 order-item transition duration-200 ease-in-out hover:shadow-lg">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <Link to={`/view-order/${order.appOrderId}`} className="text-blue-600 hover:underline font-medium">
    View Order
</Link>
                                <InvoiceComponent orderId={order.appOrderId} /> {/* <-- Render the InvoicePage component */}
                            </div>
                        </div>
